      ...
      <div
        className={
          isDarkTheme
            ...
            : "fixed inset-y-0 left-0 w-64 bg-gray-800 text-white z-50 overflow-y-auto border-gray-300 border-r-[1px] ease-in-out duration-300"
        }
      >
        <div
          className={
            isDarkTheme
              ...
              : "flex justify-between items-center px-4 py-2 border-b border-gray-300 h-[4rem] group duration-300 ease-in-out"
          }
        >
