...
const Job = ({
  ...
  return (
    <div className="bg-blue-400 m-2 sm:w-[90%] w-[80%] sm:h-[22rem] lg:px-10 lg:py-2 font-montserrat text-center mx-auto rounded-md shadow-md flex flex-col justify-center items-center">
